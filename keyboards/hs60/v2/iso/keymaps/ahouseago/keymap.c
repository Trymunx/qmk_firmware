...
#define MEN_ALT MT(MOD_RALT, KC_APP)
...
#define CTLT_Z  CTL_T(KC_Z)
#define CTLT_SL CTL_T(KC_SLSH)
#define CTLT_BS CTL_T(KC_NUBS)
#define CTLT_HS CTL_T(KC_NUHS)
...
[0] = LAYOUT_60_iso( /* COLEMAK */
    ...
    KC_LSFT,  CTLT_Z,   KC_X,     KC_C,     KC_D,     KC_V,     KC_NUBS,  KC_K,     KC_H,     KC_COMM,  KC_DOT,   CTLT_SL,           KC_RSFT,
...
[1] = LAYOUT_60_iso( /* QWERTY */
    ...
    KC_LSFT,  CTLT_BS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   CTLT_SL,           KC_RSFT,
...
[2] = LAYOUT_60_iso( /* FN */
    ...
    _______,  CTLT_BS,  _______,  _______,  _______,  _______,  _______,  KC_NUTD,  KC_EQL,   KC_MINS,  KC_PLUS,  _______,            _______,
...
[5] = LAYOUT_60_iso(
    ...
    _______,  CTLT_BS,  MOD_CUT,  MOD_CPY,  MOD_EXT,  MOD_PST, LCTL(KC_B),_______,  _______,  _______,  _______,  _______,            _______,
