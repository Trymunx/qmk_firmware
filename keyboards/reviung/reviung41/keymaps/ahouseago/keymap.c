...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT(
    ...
    _______, CTL_T(KC_NUBS), KC_NUBS,  KC_PIPE,  KC_GT,     _______,            GB_TILD,  KC_EQL,   KC_MINS,  KC_PLUS, CTL_T(KC_NUHS), _______,
                                            _______,  _______,LCTL(KC_BSPC),_______, _______
  ),

  [3] = LAYOUT(
    RGB_TOG, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,            KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
    RGB_HUI, RGB_VAI, KC_BTN2, KC_MS_U, KC_BTN1, XXXXXXX,          KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX, XXXXXXX,
    RGB_SAI, KS_BTN3, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX,          QK_BOOT, KC_WH_D, KC_WH_U, XXXXXXX, XXXXXXX, XXXXXXX,
